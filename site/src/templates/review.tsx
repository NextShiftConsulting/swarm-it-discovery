          ...
          <header className="mb-8">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6">
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  <div className="text-gray-600 dark:text-gray-400">Superfluous (S)</div>
                  <div className="font-semibold text-gray-900 dark:text-gray-100">{frontmatter.S.toFixed(2)}</div>
                </div>
                <div>
                  <div className="text-gray-600 dark:text-gray-400">Noise (N)</div>
          ...
          <footer className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                ...
                RSN scores: Relevance={frontmatter.R.toFixed(2)}, Superfluous={frontmatter.S.toFixed(2)}, Noise={frontmatter.N.toFixed(2)}.
              </p>
            </div>
          </footer>
        </div>
